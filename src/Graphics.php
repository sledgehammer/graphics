...
class Graphics extends Object
{
     ...
     * @return Graphics
     */
    public function cropped($width, $height, $offsetLeft = null, $offsetTop = null)
    {
        $gd = $this->rasterizeTruecolor();
        $top = 0;
        $left = 0;
     ...
     * @return Graphics
     */
    public function rotated($angle, $bgcolor = 'rgba(255,255,255,0)')
    {
        $gd = $this->rasterizeTruecolor();
     ...
     * @param int    $height
     */
    public function saveThumbnail($filename, $width, $height)
    {
