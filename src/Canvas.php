...
class Canvas extends Graphics
{
     ...
     * @param int $px
     */
    public function setThickness($px)
    {
    ...
    public function fillRectangle($x, $y, $width, $height, $color = null)
    {
